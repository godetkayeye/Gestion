...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        $id = intval($_GET['rid']);
        $query = mysqli_query($con, "DELETE FROM courriers WHERE id='$id'");
        echo "<script>alert('Le courrier a été supprimé.');</script>";
        echo "<script type='text/javascript'> document.location = 'courrier.php'; </script>";
    }
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="export-buttons">
                            <a href="export-courriers.php?type=pdf" class="btn btn-primary">Exporter en PDF</a>
                            <a href="add-courrier.php" class="btn btn-success">Ajouter un courrier<i class="mdi mdi-plus-circle-outline"></i></a>
                        </div>
                                        ...
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="courrier.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce courrier ?');"><i class="fa fa-trash-o" style="color: #f05050"></i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $cnt++;
