                            ...
                            <div class="panel-body">
                                <div class="table-responsive table-bordered">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            // Préparer la requête pour récupérer les courriers
                                            if ($user_role == 'admin') {
                                                ...
                                                // Si l'utilisateur est un éditeur, récupérer les courriers qui lui sont attribués
                                                $query = mysqli_query($con, "SELECT c.date, c.fichier_pdf, c.expediteur FROM courriers c
                                                            JOIN editor_permissions ep ON c.id = ep.courrier_id
                                                            WHERE ep.editor_id = '$user_id' ORDER BY c.date DESC");
                                            }
