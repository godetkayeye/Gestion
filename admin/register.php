...
if(isset($_POST['submit']))
{
    ...
    $query = mysqli_query($con, "SELECT id FROM administration WHERE email='$email'");
    ...
    if($ret > 0){
        ...
        $query1 = mysqli_query($con, "INSERT INTO administration(username, email, password) VALUES('$username', '$email', '$password')");
        if($query1){
            echo "<script>alert('Administrateur enregistré avec succès. Merci !');</script>";
                        ...
                        <div class="wrapper-page">
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    ...
                                    <a href="login0.php"><i class="mdi mdi-home"></i> Conectez-vous</a>
                                </div>
                            </div>
                        </div>
                    </div>
